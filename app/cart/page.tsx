    ...
    <div className="bg-white">
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Кошик</h1>
                  ...
                  <li key={product.id} className="flex py-6 sm:py-10">
                    ...
                    <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                      ...
                      <p className="mt-4 flex space-x-2 text-sm text-gray-700">
                        ...
                        <span>{1 ? "В наявності" : `Відправка на протязі 3-х днів`}</span>
                      </p>
                    </div>
                  </li>
                ))}
            ...
            >
              ...
              <dl className="mt-6 space-y-4">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  ...
                  <dd className="text-sm font-medium text-gray-900">₴{SHIPMENT_PRICE}</dd>
                </div>
                {/* <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                  <dt className="text-base font-medium text-gray-900">Загальна сума</dt>
